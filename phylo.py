...
if __name__ == '__main__':
    tree = load_newick('test_tree4.nwk')
    ...
    #tree = load_nexml('hayden.nexml')

    #trees = [load_newick('test_tree.nwk'), load_newick('test_tree2.nwk'), load_newick('test_tree3.nwk')]
    #trees = [load_newick('test_tree.nwk'), load_nexml('test_tree2.nexml'), load_nexus('test_tree4.nxs'), load_phyloxml('test_tree5.xml')]
    #trees = load_multiple_phyloxml('multi_test.xml')
    #trees = load_multiple_nexus('test_tree5.nxs')
    #trees = load_multiple_nexml('test_multi.nexml')
    ...
    tree.replace_in_names({'a':'AA'}, True)

    #tree.save_newick('test_tree6.nwk', support_values=True, comments=True, internal_names=False, support_as_comment=False)
    #tree.save_newick('test_tree6.nwk')
    tree.save_phyloxml('test_tree4.xml', comments=False)
    #tree.save_nexus('test_tree4.nxs', translate_command=True, comments=True)
    #tree.save_nexml('test_tree4.nexml', support_values=True, comments=False, internal_names=True)

    #save_multiple_nexus(trees, 'multi_tree.nxs', comments=False)
    #save_multiple_phyloxml(trees, 'multi_tree.xml', comments=False)
    #save_multiple_nexml(trees, 'multi_tree.nexml', comments=False)
